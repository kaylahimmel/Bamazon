...
X__1. Create a MySQL Database called `bamazon`.

X__2. Then create a Table inside of that database called `products`.

X__3. The products table should have each of the following columns:

   X__* item_id (unique id for each product)

   X__* product_name (Name of product)

   X__* department_name

   X__* price (cost to customer)
...
___8. However, if your store _does_ have enough of the product, you should fulfill the customer's order.
   ___* This means updating the SQL database to reflect the remaining quantity.
   ___* Once the update goes through, show the customer the total cost of their purchase.
